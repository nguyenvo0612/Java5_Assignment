                        ...
                        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                                    ...
                                    <div class="p-4 mt-2">
                                        <div class="d-flex justify-content-between mb-3">
                                            ...
                                            <div class="ps-2">
                                                ...
                                                <small class="fa-solid fa-star fa-bounce"
                                                       style="color: #00d6d3;"></small>
                                                <small class="fa-solid fa-star fa-bounce"
                                                       style="color: #00d6d3;"></small>
                                                <small class="fa-solid fa-star fa-bounce"
                                                       style="color: #00d6d3;"></small>
                                        ...
                                        <div class="d-flex mb-3">
                                            ...
                                            <small class="border-end me-3 pe-3"><i
                                                ...
                                                m^2</small>
                                            <small class="border-end me-3 pe-3"><i
                                                    class="fa-solid fa-layer-group fa-beat"
                                        ...
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <form action="/assignment/add-to-cart/${nha.maNha}" id="formMua"
                                                  method="post">
                                                <button class="btn btn-sm btn-dark rounded py-2 px-4" type="submit"
                                                >Add to cart</button>
                                            </form>
                                        </div>
                                    </div>
                            ...
                            <c:if test="${nha.giaCu!=null}">
                                ...
                                rounded py-1 px-3 ms-4">${nha.giaNha}
                                    ...
                                    <div class="p-4 mt-2">
                                        <div class="d-flex justify-content-between mb-3">
                                            <h5 class="mb-0">${nha.tenNha} <h2 style="color: red">Sale</h2></h5>
                                            <div class="ps-2">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            <a class="btn btn-sm btn-info rounded py-2 px-4"
                                               href="/assignment/detail-nha/${nha.maNha}">View Detail</a>
                                            <form action="/assignment/add-to-cart/${nha.maNha}"
                                                  method="post">
                                                <button class="btn btn-sm btn-dark rounded py-2 px-4" type="submit"
                                                >Add to cart</button>
                                            </form>
...
<script>
    function muaHang() {
        document.getElementById("formMua").submit();

    }

    function muaHang1() {
        document.getElementById("formMua1").submit();
