...
<section>
    <div class="container">
        ...
        <div class="row">
            <div class="col-3"></div>
            <div class="col-6">
                <form action="/assignment/quan-ly-nha/add" method="post">
                    <p>Ten nha:</p>
                    ...
                    <button type="submit" class="btn btn-success" onclick="return xacnhanadd()">Add</button>
                </form>
            </div>
            <div class="col-3"></div>
        </div>
...
<script>
    function xacnhanadd() {
        if (confirm("Ban co muon them khong?")) {
            return true;
        } else {
            return false;
        }
